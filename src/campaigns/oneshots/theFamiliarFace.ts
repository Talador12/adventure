...
export const theFamiliarFace: OneShotCampaign = {
  ...
  keyNPCs: [
    { name: 'Aldren', role: 'the double', personality: 'Identical to the party member in every physical way but with 30 years of a completely different life. A good person with a family who is terrified of losing himself. "I am not a copy. I have a wife. I have children. I am real."' },
    { name: 'Aldren\'s Wife (Senna)', role: 'the stakes', personality: 'A woman who loves her husband and is watching him become someone else in real time. "He called me by a name I do not know this morning. He looked confused about where he was. Then he was fine. Then it happened again."' },
    { name: 'Sage Theren', role: 'information', personality: 'A planar scholar who identifies the soul bifurcation and provides the solution. "This is exceedingly rare. A single soul, divided by a planar rift, living two complete lives. Both are original. Neither is the copy. And if you do not separate them soon, only one will remain."' },
  ],
  keyLocations: [
