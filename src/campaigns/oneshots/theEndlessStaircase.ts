...
export const theEndlessStaircase: OneShotCampaign = {
  ...
  tagline: 'Landing one: a forest outside the window. Landing ten: a swamp under a green moon. Landing twenty: an ocean of black water. The stairs do not end.',
  tone: 'exploration',
  ...
  scenes: [
    {
      ...
      keyEvents: [
        'Landings 1-5: familiar forests, then distant mountains, then a coastline none of them recognize. The air through each window smells different - pine, salt, copper',
        'Landings 6-10: a swamp under a green moon, a grassland where the sky is the wrong shade of blue, a desert under three suns that cast overlapping shadows',
        'Landings 11-20: a city growing upside-down from a ceiling of stone, an ocean suspended in midair, a void with no stars where the window glass frosts instantly',
  ...
  keyNPCs: [
    { name: 'The Architect', role: 'trapped creator', personality: 'Their body phases between planes, one arm in fire, one in water, torso in void. Their voice sounds like it comes from several places at once. Not bitter. Just tired in a way that goes beyond sleep. "I built a road between worlds. The road needed an anchor. I volunteered. That was eleven thousand years ago. I would like to sit down somewhere that stays still."' },
