  ...
  scenes: [
    {
      ...
      keyEvents: [
        'First echoes: normal, expected, natural acoustics',
        'The shift: echoes arrive late, then say different words in the party\'s voices',
        'Escalation: the echoes use the party\'s names, reference secrets, give warnings',
        'The echoes become conversational: "Turn back. We did not. Look where it got us."',
      ],
    },
    {
    ...
    },
    {
      ...
      challenge: 'combat',
      keyEvents: [
        'The center: a circular room with perfect acoustics and bodies wearing the party\'s gear',
        'The bodies are from a parallel timeline or a previous loop, dead for days',
        'The echoes solidify into sound constructs that fight using the party\'s own abilities',
        'Destroying the acoustic heart: a resonating crystal at the room\'s center that stores all captured sound',
      ],
    },
  ],
  keyNPCs: [
