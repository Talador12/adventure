...
export const theNorthernLights: OneShotCampaign = {
  ...
  tagline: 'The aurora touches the ground. Where it touches, a path appears leading into the sky.',
  tone: 'exploration',
  ...
  scenes: [
    {
      ...
      keyEvents: [
        'The staircase: solid light, warm underfoot, with no rails and wind from every direction',
        'Passing through clouds: the party is soaked, then frozen, then dried by starlight',
        'The view: the entire continent visible below, shrinking with each step',
