...
export const theChainBreaker: OneShotCampaign = {
  ...
  tagline: 'A titan chained beneath a mountain for eons. The chains are breaking. Free it or reinforce them.',
  tone: 'epic',
  ...
  scenes: [
    ...
    },
    {
      ...
      challenge: 'social',
      keyEvents: [
        'The celestial envoy: arrives in divine light, demands the chains be reinforced',
        'The celestial\'s argument: "She is a force of nature. Unchained, she will reshape the world."',
        'Thane\'s argument: "I was chained for loving your kind. The gods feared that love."',
        'The decision: reinforce (the gods\' will), free (Thane\'s plea), or break the mechanism entirely (chaos)',
      ],
    },
  ],
  keyNPCs: [
    ...
    { name: 'Historian Kael', role: 'guide', personality: 'A mortal scholar who has spent thirty years studying the mountain. He found the erased glyphs. He knows the gods edited the story.' },
  ],
  keyLocations: [
