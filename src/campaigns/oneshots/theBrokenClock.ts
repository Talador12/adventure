...
export const theBrokenClock: OneShotCampaign = {
  ...
  tagline: 'A clock stopped at the exact moment something terrible happened. Restarting it requires understanding why.',
  tone: 'serious',
  ...
  scenes: [
    ...
    },
    {
      ...
      challenge: 'social',
      keyEvents: [
        'Evidence assembled: the expelled student had motive, opportunity, and no alibi',
        'Confrontation: the councilmember denies it, then breaks when presented with proof',
        'The confession: spoken in the square below the clock, heard by the gathered town',
        'The clock moves: 3:47 becomes 3:48. Then 3:49. Time resumes. The town unsticks',
      ],
    },
  ],
  keyNPCs: [
    { name: 'Clockmaker Henn', role: 'quest giver / ally', personality: 'A frustrated artisan who has tried everything mechanical and cannot accept that the solution is not in the gears. "It is a clock. Clocks are logical. This is not logical."' },
    { name: 'Councilmember Aldric Vane', role: 'antagonist', personality: 'A man who murdered his teacher 6 months ago and built a career on the silence that followed. Outwardly composed, inwardly terrified that someone will connect the dots. He pushed to defund the investigation.' },
    { name: 'Teacher Elwin (deceased)', role: 'the victim', personality: 'Present in memories and records. A kind, demanding teacher who held students to high standards and caught Vane cheating on his examinations. His murder was personal, not random.' },
  ],
  keyLocations: [
