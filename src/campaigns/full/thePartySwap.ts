  ...
  acts: [
    {
      ...
      keyEvents: [
        ...
        'First swap: 24 hours pass. New combination. Chaos multiplies. Spiral begins: each swap combination creates new comedy. The paladin in the rogue body keeps trying to be honorable while picking pockets. The wizard in the fighter body discovers they LIKE hitting things.',
      ],
      estimatedSessions: 3,
    },
    {
    ...
    },
    {
      ...
      keyEvents: [
        ...
        'Victory: the party wins in borrowed bodies. The fey is genuinely impressed. The curse breaks. Everyone is home. Chaos callback: once back in their own bodies, each party member catches themselves using a habit from someone else. The fighter tries to cast a cantrip. The wizard flexes. They are changed. The swap is gone but the understanding remains.',
      ],
      estimatedSessions: 3,
    },
  ],
