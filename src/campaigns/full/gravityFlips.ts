  ...
  acts: [
    {
      ...
      keyEvents: [
        ...
        'A local offers to teach the party "flip etiquette." Lesson one: always check which floor someone is on before shaking hands.',
      ],
      estimatedSessions: 3,
    },
    {
    ...
    },
    {
      ...
      keyEvents: [
        ...
        'Resolution: the architect stamps the pocket dimension as "intentional design variation" and leaves. Bureaucracy saves the day.',
      ],
      estimatedSessions: 3,
    },
  ],
