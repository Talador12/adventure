  ...
  acts: [
    ...
    },
    {
      ...
      keyEvents: [
        ...
        'A warlord offers safe passage in exchange for able-bodied fighters. He wants twenty of the caravan\'s strongest.',
    ...
    },
    {
      ...
      keyEvents: [
        ...
        'The refugees are one revelation away from lynching. They lost everything because of her war.',
  ...
  keyNPCs: [
    {
      ...
      personality: 'Intelligent, regal despite her disguise, and genuinely caring toward the refugees even as she plans to restart the conflict that displaced them. She believes her restoration will bring stability. She might be right. She might be delusional. "I did not start the war. I lost the war. The people who won are worse. I am the lesser evil."',
    ...
    },
    {
      ...
      personality: 'A weary cleric who tends to the spiritual needs of 200 traumatized people. He does not preach. He listens. He carries the dead. He sings when morale breaks. "I do not have answers. I have a shovel and a song."',
    },
    {
      name: 'Vex',
      role: 'scout / former soldier',
      personality: 'A deserter from the Tarshan army who joined the caravan to escape the war. She is the best pathfinder in the group. Sharp, cynical, and one recognition check away from identifying Lysara. "I killed people for her crown. I would rather die than do it again."',
      secret: 'She already suspects Maren. She is watching. She is deciding.',
    },
    {
      name: 'Little Asha',
      role: 'Lysara\'s daughter / innocent stakes',
      personality: 'A six-year-old who thinks her mother is a seamstress named Maren. She has made friends with every child in the caravan. She does not understand the war or why they are walking. She just wants to stop walking.',
    },
  ],
  keyLocations: [
    { name: 'The War Road', description: 'A 400-mile stretch of contested territory. Burned villages, military checkpoints, destroyed infrastructure. Every mile is a negotiation.', significance: 'The campaign is the road. Every session is a different stretch.' },
    { name: 'The Ruins of Ashmark', description: 'A destroyed fortress where the caravan takes shelter during a storm. Defensible but haunted by the battle that destroyed it.', significance: 'The midpoint crisis: settle here or press on?' },
    { name: 'Velmere', description: 'The free city at the end of the road. Open gates, clean water, and a future. The last city that will take refugees.', significance: 'The destination. The finish line. The place where Lysara\'s allies are waiting.' },
  ],
  dataSystems: ['wildernessSurvival', 'cataclysmCountdown', 'socialEncounter', 'npcRelationshipWeb', 'encounterWaves', 'factionWar', 'diplomaticNegotiation', 'settlementEvent', 'backstoryComplication'],
};
