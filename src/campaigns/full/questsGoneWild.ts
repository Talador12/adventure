  ...
  acts: [
    {
      ...
      keyEvents: [
        ...
        'The pattern: every absurd quest has a technically valid solution if interpreted creatively enough.',
      ],
      estimatedSessions: 4,
    },
    {
    ...
    },
    {
      ...
      keyEvents: [
        ...
        'Completion: the board weeps with pride (magically, through the wood grain). It retires. Normal quests resume.',
      ],
      estimatedSessions: 4,
    },
  ],
