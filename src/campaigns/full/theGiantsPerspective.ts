  ...
  acts: [
    {
      ...
      keyEvents: [
        ...
        'A "fearsome dragon" attacks the city. It is knee-height. The party punts it. The city is horrified and grateful. Running gag begins: the party keeps accidentally destroying things by existing near them. A running tally of property damage is maintained by Councilwoman Slatewood.',
    ...
    },
    {
      ...
      keyEvents: [
        ...
        'Callback: Councilwoman Slatewood presents the final property damage bill. It is longer than the original quest scroll. Regardless of the ending, the bill is forgiven — the party saved the world. She does not look happy about it.',
      ],
      estimatedSessions: 5,
    },
  ],
