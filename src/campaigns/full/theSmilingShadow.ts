  ...
  acts: [
    {
      ...
      keyEvents: [
        ...
        'Gift basket outside their room: imported chocolates, a pressed flower, and a crossbow bolt with a ribbon on it. Running gag begins: every assassination attempt is preceded by a card on cream stationery with impeccable calligraphy. The party starts rating the stationery.',
      ],
      estimatedSessions: 5,
    },
    {
    ...
    },
    {
      ...
      keyEvents: [
        ...
        'Resolution: the contract breaks, Velmaris yields, or someone dies. Velmaris accepts all outcomes with grace. Callback: one final card arrives the next morning. Cream stationery. Wax seal. "Thank you for a wonderful season. I have enclosed a gift basket. There is nothing in it that will kill you. Probably. With warmest regards, V."',
      ],
      estimatedSessions: 5,
    },
  ],
