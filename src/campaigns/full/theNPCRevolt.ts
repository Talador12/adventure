  ...
  acts: [
    {
      ...
      keyEvents: [
        ...
        'The guards at the city gate start asking THEMSELVES for identification. Spiral begins: each session, a new category of NPC becomes self-aware and immediately has the most reasonable complaint imaginable. The escalation is not violence - it is increasingly valid grievances that the party cannot argue with.',
      ],
      estimatedSessions: 5,
    },
    {
    ...
    },
    {
      ...
      keyEvents: [
        ...
        'The Accord: a new social contract is signed. NPCs get rights. The world gets weird but functional. Chaos callback: Barkeep Aldric finally drinks his first ale. It is warm. He does not care. He chose it. That is what matters.',
      ],
      estimatedSessions: 4,
    },
  ],
