  ...
  acts: [
    {
      ...
      keyEvents: [
        ...
        'The realization: Murray is in every room at the same time. He does not know how either.',
      ],
      estimatedSessions: 4,
    },
    {
    ...
    },
    {
      ...
      keyEvents: [
        ...
        'The exit: Murray steps outside. The sky is enormous. He cries. The tavern stops growing. It shrinks to a single, perfect room.',
      ],
      estimatedSessions: 4,
    },
  ],
