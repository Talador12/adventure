  ...
  acts: [
    {
      ...
      keyEvents: [
        ...
        'The pattern is undeniable. The party hires a genealogist who immediately has a nervous breakdown. Spiral begins: each new villain reveal is more awkward than the last. Uncle is manageable. Cousin is weird. College roommate is personal. By Act 2, the party dreads victory because it always means a family complication.',
      ],
      estimatedSessions: 4,
    },
    {
    ...
    },
    {
      ...
      keyEvents: [
        ...
        'Reconciliation: through tears, grudging apologies, and one very good pie, the curse breaks. Chaos callback: the genealogist finishes the family tree. It is framed and hung in the estate. The bottom reads "And they all lived, mostly, together." Bertram Bones still owes 50 gold. He will never pay it.',
      ],
      estimatedSessions: 4,
    },
  ],
