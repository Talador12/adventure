  ...
  acts: [
    ...
    },
    {
      ...
      keyEvents: [
        ...
        'A faction in the village wants to abandon the sick and move faster. The party must hold the group together.',
    ...
    },
    {
      ...
      keyEvents: [
        ...
        'Convincing the village to turn around. Trust is nearly gone. The party must prove they know the way out.',
  ...
  keyNPCs: [
    {
      ...
      personality: 'A tough, practical woman who held the village together for forty sunless days before her body gave out. Her authority passes to the party. "I kept them alive. Now you keep them moving."',
    },
    {
      name: 'Brennan the Smith',
      role: 'pragmatist / potential antagonist',
      personality: 'A strong man who believes survival requires hard choices. He wants to leave the sick behind, reduce the group to those who can walk, and move fast. He is not wrong about the math. He is wrong about what it costs.',
    ...
    },
    {
      ...
      personality: 'Known through her journal: a compassionate, powerful druid who saw the war coming and panicked. She did not mean for this to happen. "If I am dead and you are reading this, I am sorry. The exit is at my tree. I hope someone finds this in time."',
    },
    {
      name: 'Pip',
      role: 'orphan child / morale anchor',
      personality: 'A ten-year-old who lost both parents in the first week of darkness. She refuses to cry. She carries firewood. She tells stories at night. She is the reason people keep walking.',
    },
  ],
  keyLocations: [
    { name: 'Thornwall', description: 'A farming village now buried in frost. The starting point and, unknowingly, near the destination.', significance: 'Where the journey begins and nearly ends.' },
    { name: 'The Edge', description: 'The boundary of the demiplane. A wall of featureless white where reality ends. Terrifying to behold.', significance: 'The proof that the world is wrong and the party must change course.' },
    { name: 'Ysolde\'s Tree', description: 'A living oak in the center of the demiplane, green and warm in a world of ice. Ysolde\'s body rests at its roots.', significance: 'The exit. The ritual site. The key to going home.' },
  ],
  dataSystems: ['wildernessSurvival', 'cataclysmCountdown', 'settlementEvent', 'socialEncounter', 'encounterWaves', 'magicalAnomaly', 'npcRelationshipWeb', 'backstoryComplication'],
};
