  ...
  acts: [
    {
      ...
      keyEvents: [
        ...
        'The romance: the fighter\'s sword develops feelings for the paladin\'s shield. It is incredibly awkward.',
      ],
      estimatedSessions: 3,
    },
    {
    ...
    },
    {
      ...
      keyEvents: [
        ...
        'The choice: reform the god (silence the weapons), preserve individuals, or the noisy compromise.',
      ],
      estimatedSessions: 3,
    },
  ],
