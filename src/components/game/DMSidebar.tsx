        ...
        {dmSidebarTab === 'encounter' && (
          <>
            ...
            <button onClick={async () => { const { getRandomCampEvent, formatCampEvent } = await import('../../data/randomCampEvent'); onAddDmMessage(formatCampEvent(getRandomCampEvent())); }}
             ...
             <button onClick={async () => { const { getRandomLairAction, formatLairAction } = await import('../../data/lairAction'); onAddDmMessage(formatLairAction(getRandomLairAction())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-red-900/20 border border-red-600/30 text-red-400 hover:bg-red-800/30 transition-all">🐉 Lair Action</button>
             <button onClick={async () => { const { getRandomStorm, formatStorm } = await import('../../data/elementalStorm'); onAddDmMessage(formatStorm(getRandomStorm())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-orange-900/20 border border-orange-600/30 text-orange-400 hover:bg-orange-800/30 transition-all">⛈️ Elemental Storm</button>
             <button onClick={async () => { const { getRandomAftermath, formatAftermath } = await import('../../data/battlefieldAftermath'); onAddDmMessage(formatAftermath(getRandomAftermath())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-orange-900/20 border border-orange-600/30 text-orange-400 hover:bg-orange-800/30 transition-all">💀 Battlefield Aftermath</button>
             <button onClick={async () => { const { getRandomAmbush, formatAmbush } = await import('../../data/caravanAmbush'); onAddDmMessage(formatAmbush(getRandomAmbush())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-orange-900/20 border border-orange-600/30 text-orange-400 hover:bg-orange-800/30 transition-all">🌲 Caravan Ambush</button>
             <button onClick={async () => { const { getRandomAlliance, formatAlliance } = await import('../../data/monsterAlliance'); onAddDmMessage(formatAlliance(getRandomAlliance())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-orange-900/20 border border-orange-600/30 text-orange-400 hover:bg-orange-800/30 transition-all">🤝 Monster Alliance</button>
             <button onClick={async () => { const { getRandomEvolvingMonster, formatEvolvingMonster } = await import('../../data/monsterEvolution'); onAddDmMessage(formatEvolvingMonster(getRandomEvolvingMonster(), 1)); }} className="w-full mb-1 text-[10px] py-1 rounded bg-red-900/20 border border-red-600/30 text-red-400 hover:bg-red-800/30 transition-all">📈 Evolving Monster</button>

             {/* World & Location */}
             <label className="text-[9px] text-blue-400 font-bold uppercase mt-2 mb-1 block">🌍 World Building</label>
             <button onClick={async () => { const { getRandomEnchantedForest, formatEnchantedForest } = await import('../../data/enchantedForest'); onAddDmMessage(formatEnchantedForest(getRandomEnchantedForest())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-green-900/20 border border-green-600/30 text-green-400 hover:bg-green-800/30 transition-all">🌳 Enchanted Forest</button>
             <button onClick={async () => { const { getRandomHauntedLocation, formatHauntedLocation } = await import('../../data/hauntedLocation'); onAddDmMessage(formatHauntedLocation(getRandomHauntedLocation())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-purple-900/20 border border-purple-600/30 text-purple-400 hover:bg-purple-800/30 transition-all">👻 Haunted Location</button>
             <button onClick={async () => { const { getRandomRuin, formatRuin } = await import('../../data/ancientRuinLayout'); onAddDmMessage(formatRuin(getRandomRuin())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-amber-900/20 border border-amber-600/30 text-amber-400 hover:bg-amber-800/30 transition-all">🏛️ Ancient Ruin</button>
             <button onClick={async () => { const { getRandomDimension, formatDimension } = await import('../../data/pocketDimension'); onAddDmMessage(formatDimension(getRandomDimension())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-indigo-900/20 border border-indigo-600/30 text-indigo-400 hover:bg-indigo-800/30 transition-all">🌀 Pocket Dimension</button>
             <button onClick={async () => { const { getRandomMirrorDimension, formatMirrorDimension } = await import('../../data/mirrorDimension'); onAddDmMessage(formatMirrorDimension(getRandomMirrorDimension())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-indigo-900/20 border border-indigo-600/30 text-indigo-400 hover:bg-indigo-800/30 transition-all">🪞 Mirror Dimension</button>
             <button onClick={async () => { const { getRandomClockworkDungeon, formatClockworkDungeon } = await import('../../data/clockworkDungeon'); onAddDmMessage(formatClockworkDungeon(getRandomClockworkDungeon())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-amber-900/20 border border-amber-600/30 text-amber-400 hover:bg-amber-800/30 transition-all">⚙️ Clockwork Dungeon</button>
             <button onClick={async () => { const { getRandomTimeLoop, formatTimeLoop } = await import('../../data/timeLoopDungeon'); onAddDmMessage(formatTimeLoop(getRandomTimeLoop())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-cyan-900/20 border border-cyan-600/30 text-cyan-400 hover:bg-cyan-800/30 transition-all">🔁 Time Loop Dungeon</button>
             <button onClick={async () => { const { getRandomCorridor, formatCorridor } = await import('../../data/trapCorridor'); onAddDmMessage(formatCorridor(getRandomCorridor())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-red-900/20 border border-red-600/30 text-red-400 hover:bg-red-800/30 transition-all">🏚️ Trap Corridor</button>

             {/* NPC & Social */}
             <label className="text-[9px] text-emerald-400 font-bold uppercase mt-2 mb-1 block">👥 NPCs & Social</label>
             <button onClick={async () => { const { getDragonProfile, getAllDragonColors } = await import('../../data/dragonPersonality'); const colors = getAllDragonColors(); const p = getDragonProfile(colors[Math.floor(Math.random() * colors.length)])!; const { formatDragonProfile } = await import('../../data/dragonPersonality'); onAddDmMessage(formatDragonProfile(p)); }} className="w-full mb-1 text-[10px] py-1 rounded bg-red-900/20 border border-red-600/30 text-red-400 hover:bg-red-800/30 transition-all">🐉 Dragon Personality</button>
             <button onClick={async () => { const { getRandomVoice, formatVoiceProfile } = await import('../../data/npcVoiceAccent'); onAddDmMessage(formatVoiceProfile(getRandomVoice())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-emerald-900/20 border border-emerald-600/30 text-emerald-400 hover:bg-emerald-800/30 transition-all">🎭 NPC Voice</button>
             <button onClick={async () => { const { getRandomBackstory, formatBackstory } = await import('../../data/npcBackstoryGen'); onAddDmMessage(formatBackstory(getRandomBackstory(), true)); }} className="w-full mb-1 text-[10px] py-1 rounded bg-emerald-900/20 border border-emerald-600/30 text-emerald-400 hover:bg-emerald-800/30 transition-all">📖 NPC Backstory</button>
             <button onClick={async () => { const { getRandomRivalParty, formatRivalParty } = await import('../../data/rivalParty'); onAddDmMessage(formatRivalParty(getRandomRivalParty())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-yellow-900/20 border border-yellow-600/30 text-yellow-400 hover:bg-yellow-800/30 transition-all">⚔️ Rival Party</button>
             <button onClick={async () => { const { getRandomPet, formatPet } = await import('../../data/npcPetCompanion'); onAddDmMessage(formatPet(getRandomPet())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-emerald-900/20 border border-emerald-600/30 text-emerald-400 hover:bg-emerald-800/30 transition-all">🐾 NPC Pet</button>
             <button onClick={async () => { const { getRandomDeathScene, formatDeathScene } = await import('../../data/npcDeathScene'); onAddDmMessage(formatDeathScene(getRandomDeathScene(), 'The NPC')); }} className="w-full mb-1 text-[10px] py-1 rounded bg-slate-900/20 border border-slate-600/30 text-slate-400 hover:bg-slate-800/30 transition-all">⚰️ Death Scene</button>
             <button onClick={async () => { const { getRandomMonologue, formatMonologue } = await import('../../data/villainMonologue'); onAddDmMessage(formatMonologue(getRandomMonologue())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-red-900/20 border border-red-600/30 text-red-400 hover:bg-red-800/30 transition-all">😈 Villain Monologue</button>
             <button onClick={async () => { const { getRandomOracle, formatOracle } = await import('../../data/oracleConsultation'); onAddDmMessage(formatOracle(getRandomOracle())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-purple-900/20 border border-purple-600/30 text-purple-400 hover:bg-purple-800/30 transition-all">🔮 Oracle</button>
             <button onClick={async () => { const { getRandomArtist, formatArtist } = await import('../../data/tattooArtist'); onAddDmMessage(formatArtist(getRandomArtist())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-pink-900/20 border border-pink-600/30 text-pink-400 hover:bg-pink-800/30 transition-all">🎨 Tattoo Artist</button>

             {/* Story & Plot */}
             <label className="text-[9px] text-yellow-400 font-bold uppercase mt-2 mb-1 block">📜 Story & Plot</label>
             <button onClick={async () => { const { getRandomCataclysm, formatCataclysm } = await import('../../data/cataclysmCountdown'); onAddDmMessage(formatCataclysm(getRandomCataclysm())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-red-900/20 border border-red-600/30 text-red-400 hover:bg-red-800/30 transition-all">🌋 Cataclysm</button>
             <button onClick={async () => { const { getRandomAncientProphecy, formatProphecy } = await import('../../data/ancientProphecy'); onAddDmMessage(formatProphecy(getRandomAncientProphecy(), true)); }} className="w-full mb-1 text-[10px] py-1 rounded bg-purple-900/20 border border-purple-600/30 text-purple-400 hover:bg-purple-800/30 transition-all">🔮 Ancient Prophecy</button>
             <button onClick={async () => { const { getRandomBargain, formatBargain } = await import('../../data/darkBargain'); onAddDmMessage(formatBargain(getRandomBargain(), true)); }} className="w-full mb-1 text-[10px] py-1 rounded bg-red-900/20 border border-red-600/30 text-red-400 hover:bg-red-800/30 transition-all">👹 Dark Bargain</button>
             <button onClick={async () => { const { getRandomDivineQuest, formatDivineQuest } = await import('../../data/divineQuestGiver'); onAddDmMessage(formatDivineQuest(getRandomDivineQuest())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-yellow-900/20 border border-yellow-600/30 text-yellow-400 hover:bg-yellow-800/30 transition-all">✨ Divine Quest</button>
             <button onClick={async () => { const { getRandomQuestChain, formatQuestChain } = await import('../../data/factionQuestChain'); onAddDmMessage(formatQuestChain(getRandomQuestChain())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-blue-900/20 border border-blue-600/30 text-blue-400 hover:bg-blue-800/30 transition-all">🏛️ Faction Quest</button>
             <button onClick={async () => { const { getRandomMarriage, formatMarriage } = await import('../../data/politicalMarriage'); onAddDmMessage(formatMarriage(getRandomMarriage())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-pink-900/20 border border-pink-600/30 text-pink-400 hover:bg-pink-800/30 transition-all">💍 Political Marriage</button>
             <button onClick={async () => { const { getRandomExile, formatExile } = await import('../../data/exileScenario'); onAddDmMessage(formatExile(getRandomExile())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-amber-900/20 border border-amber-600/30 text-amber-400 hover:bg-amber-800/30 transition-all">🚫 Exile Scenario</button>
             <button onClick={async () => { const { getRandomPrisonBreak, formatPrisonBreak } = await import('../../data/prisonBreak'); onAddDmMessage(formatPrisonBreak(getRandomPrisonBreak())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-slate-900/20 border border-slate-600/30 text-slate-400 hover:bg-slate-800/30 transition-all">⛓️ Prison Break</button>

             {/* Items & Treasure */}
             <label className="text-[9px] text-amber-400 font-bold uppercase mt-2 mb-1 block">💎 Items & Treasure</label>
             <button onClick={async () => { const { getRandomHoard, formatHoard } = await import('../../data/cursedTreasure'); onAddDmMessage(formatHoard(getRandomHoard())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-amber-900/20 border border-amber-600/30 text-amber-400 hover:bg-amber-800/30 transition-all">💰 Cursed Treasure</button>
             <button onClick={async () => { const { getRandomHauntedItem, formatHauntedItem } = await import('../../data/hauntedItem'); onAddDmMessage(formatHauntedItem(getRandomHauntedItem())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-purple-900/20 border border-purple-600/30 text-purple-400 hover:bg-purple-800/30 transition-all">👻 Haunted Item</button>
             <button onClick={async () => { const { getRandomSentientItem, formatSentientItem } = await import('../../data/sentientItem'); onAddDmMessage(formatSentientItem(getRandomSentientItem())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-purple-900/20 border border-purple-600/30 text-purple-400 hover:bg-purple-800/30 transition-all">🗡️ Sentient Item</button>
             <button onClick={async () => { const { getRandomPetPeeve, formatPetPeeve } = await import('../../data/magicalPetPeeve'); onAddDmMessage(formatPetPeeve(getRandomPetPeeve())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-amber-900/20 border border-amber-600/30 text-amber-400 hover:bg-amber-800/30 transition-all">😤 Item Pet Peeve</button>
             <button onClick={async () => { const { getRandomArmorQuirk, formatArmorQuirk } = await import('../../data/enchantedArmorQuirk'); onAddDmMessage(formatArmorQuirk(getRandomArmorQuirk())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-blue-900/20 border border-blue-600/30 text-blue-400 hover:bg-blue-800/30 transition-all">🛡️ Armor Quirk</button>
             <button onClick={async () => { const { getRandomRivalry, formatRivalry } = await import('../../data/weaponRivalry'); onAddDmMessage(formatRivalry(getRandomRivalry())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-red-900/20 border border-red-600/30 text-red-400 hover:bg-red-800/30 transition-all">⚔️ Weapon Rivalry</button>
             <button onClick={async () => { const { getRandomFood, formatFood } = await import('../../data/enchantedFoodDrink'); onAddDmMessage(formatFood(getRandomFood())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-green-900/20 border border-green-600/30 text-green-400 hover:bg-green-800/30 transition-all">🍲 Enchanted Food</button>

             {/* Misc Generators */}
             <label className="text-[9px] text-teal-400 font-bold uppercase mt-2 mb-1 block">🎲 Misc Generators</label>
             <button onClick={async () => { const { getRandomSociety, formatSociety } = await import('../../data/secretSociety'); onAddDmMessage(formatSociety(getRandomSociety())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-slate-900/20 border border-slate-600/30 text-slate-400 hover:bg-slate-800/30 transition-all">🕵️ Secret Society</button>
             <button onClick={async () => { const { getRandomCourtCase, formatCase } = await import('../../data/magicalCourtroom'); onAddDmMessage(formatCase(getRandomCourtCase())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-blue-900/20 border border-blue-600/30 text-blue-400 hover:bg-blue-800/30 transition-all">⚖️ Court Case</button>
             <button onClick={async () => { const { getRandomMishap, formatMishap } = await import('../../data/teleportMishap'); onAddDmMessage(formatMishap(getRandomMishap())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-cyan-900/20 border border-cyan-600/30 text-cyan-400 hover:bg-cyan-800/30 transition-all">🌀 Teleport Mishap</button>
             <button onClick={async () => { const { getRandomPlanarWeather, formatPlanarWeather } = await import('../../data/planarWeather'); onAddDmMessage(formatPlanarWeather(getRandomPlanarWeather())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-indigo-900/20 border border-indigo-600/30 text-indigo-400 hover:bg-indigo-800/30 transition-all">🌈 Planar Weather</button>
             <button onClick={async () => { const { getRandomForecast, formatForecast } = await import('../../data/magicalForecast'); onAddDmMessage(formatForecast(getRandomForecast())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-teal-900/20 border border-teal-600/30 text-teal-400 hover:bg-teal-800/30 transition-all">🔮 Magic Forecast</button>
             <button onClick={async () => { const { getRandomEntertainment, formatEntertainment } = await import('../../data/tavernEntertainment'); onAddDmMessage(formatEntertainment(getRandomEntertainment())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-amber-900/20 border border-amber-600/30 text-amber-400 hover:bg-amber-800/30 transition-all">🎪 Tavern Event</button>
             <button onClick={async () => { const { getRandomMount, formatMount } = await import('../../data/beastMount'); onAddDmMessage(formatMount(getRandomMount())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-green-900/20 border border-green-600/30 text-green-400 hover:bg-green-800/30 transition-all">🐎 Beast Mount</button>
             <button onClick={async () => { const { getRandomInheritance, formatInheritance } = await import('../../data/magicalInheritance'); onAddDmMessage(formatInheritance(getRandomInheritance())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-amber-900/20 border border-amber-600/30 text-amber-400 hover:bg-amber-800/30 transition-all">📜 Inheritance</button>
             <button onClick={async () => { const { getRandomBlackMarketItem, formatBlackMarketItem } = await import('../../data/arcaneBlackMarket'); onAddDmMessage(formatBlackMarketItem(getRandomBlackMarketItem(), true)); }} className="w-full mb-1 text-[10px] py-1 rounded bg-slate-900/20 border border-slate-600/30 text-slate-400 hover:bg-slate-800/30 transition-all">🏴 Black Market</button>
             <button onClick={async () => { const { getRandomRebellion, formatRebellion } = await import('../../data/familiarRebellion'); onAddDmMessage(formatRebellion(getRandomRebellion())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-emerald-900/20 border border-emerald-600/30 text-emerald-400 hover:bg-emerald-800/30 transition-all">✊ Familiar Rebellion</button>
             <button onClick={async () => { const { getRandomCamp, formatCamp } = await import('../../data/apocalypseCamp'); onAddDmMessage(formatCamp(getRandomCamp())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-red-900/20 border border-red-600/30 text-red-400 hover:bg-red-800/30 transition-all">🏕️ Survivor Camp</button>
             <button onClick={async () => { const { getRandomLair, formatLair } = await import('../../data/villainLair'); onAddDmMessage(formatLair(getRandomLair())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-red-900/20 border border-red-600/30 text-red-400 hover:bg-red-800/30 transition-all">👑 Villain Lair</button>
             <button onClick={async () => { const { getRandomHistory, formatHistory } = await import('../../data/artifactHistory'); onAddDmMessage(formatHistory(getRandomHistory())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-amber-900/20 border border-amber-600/30 text-amber-400 hover:bg-amber-800/30 transition-all">📜 Artifact History</button>
             <button onClick={async () => { const { getRandomScandal, formatScandal } = await import('../../data/nobleScandalGen'); onAddDmMessage(formatScandal(getRandomScandal(), true)); }} className="w-full mb-1 text-[10px] py-1 rounded bg-pink-900/20 border border-pink-600/30 text-pink-400 hover:bg-pink-800/30 transition-all">💋 Noble Scandal</button>
             <button onClick={async () => { const { getRandomPuzzle, formatPuzzle } = await import('../../data/ancientLanguageDecoder'); onAddDmMessage(formatPuzzle(getRandomPuzzle(), true)); }} className="w-full mb-1 text-[10px] py-1 rounded bg-cyan-900/20 border border-cyan-600/30 text-cyan-400 hover:bg-cyan-800/30 transition-all">📜 Ancient Inscription</button>
             <button onClick={async () => { const { getRandomWarden, formatWarden } = await import('../../data/prisonWarden'); onAddDmMessage(formatWarden(getRandomWarden())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-slate-900/20 border border-slate-600/30 text-slate-400 hover:bg-slate-800/30 transition-all">🔒 Prison Warden</button>
             <button onClick={async () => { const { getRandomAspect, formatAspect } = await import('../../data/deityAspect'); onAddDmMessage(formatAspect(getRandomAspect())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-yellow-900/20 border border-yellow-600/30 text-yellow-400 hover:bg-yellow-800/30 transition-all">✨ Deity Aspect</button>
             <button onClick={async () => { const { getRandomResonance, formatResonance } = await import('../../data/artifactResonance'); onAddDmMessage(formatResonance(getRandomResonance())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-purple-900/20 border border-purple-600/30 text-purple-400 hover:bg-purple-800/30 transition-all">🎵 Item Resonance</button>
             <button onClick={async () => { const { getRandomReading, formatReading } = await import('../../data/needCompass'); onAddDmMessage(formatReading(getRandomReading())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-teal-900/20 border border-teal-600/30 text-teal-400 hover:bg-teal-800/30 transition-all">🧭 Need Compass</button>
             <button onClick={async () => { const { getRandomAccident, formatAccident } = await import('../../data/magicalAccident'); onAddDmMessage(formatAccident(getRandomAccident(), true)); }} className="w-full mb-1 text-[10px] py-1 rounded bg-orange-900/20 border border-orange-600/30 text-orange-400 hover:bg-orange-800/30 transition-all">🔬 Magic Accident</button>
             <button onClick={async () => { const { getRandomWeb, formatWeb } = await import('../../data/npcRelationWeb'); onAddDmMessage(formatWeb(getRandomWeb(), true)); }} className="w-full mb-1 text-[10px] py-1 rounded bg-emerald-900/20 border border-emerald-600/30 text-emerald-400 hover:bg-emerald-800/30 transition-all">🕸️ NPC Web</button>
             <button onClick={async () => { const { getRandomZone, formatZone } = await import('../../data/magicalContamination'); onAddDmMessage(formatZone(getRandomZone())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-green-900/20 border border-green-600/30 text-green-400 hover:bg-green-800/30 transition-all">☢️ Magic Contamination</button>
             <button onClick={async () => { const { getRandomLastStand, formatLastStand } = await import('../../data/legendaryLastStand'); onAddDmMessage(formatLastStand(getRandomLastStand())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-red-900/20 border border-red-600/30 text-red-400 hover:bg-red-800/30 transition-all">🏰 Last Stand</button>
             ...
             <button onClick={async () => { const { getRandomStory, formatStory } = await import('../../data/campfireStory'); onAddDmMessage(formatStory(getRandomStory())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-amber-900/20 border border-amber-600/30 text-amber-400 hover:bg-amber-800/30 transition-all">🔥 Campfire Story</button>
              ...
              {/* Wave 69 generators */}
              <button onClick={async () => { const { getRandomSpirit, formatSpirit } = await import('../../data/tricksterSpirit'); onAddDmMessage(formatSpirit(getRandomSpirit())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-pink-900/20 border border-pink-600/30 text-pink-400 hover:bg-pink-800/30 transition-all">🦊 Trickster Spirit</button>
              <button onClick={async () => { const { getRandomLabyrinth, formatLabyrinth } = await import('../../data/livingLabyrinth'); onAddDmMessage(formatLabyrinth(getRandomLabyrinth())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-violet-900/20 border border-violet-600/30 text-violet-400 hover:bg-violet-800/30 transition-all">🏰 Living Labyrinth</button>
              <button onClick={async () => { const { getRandomShip, formatShip } = await import('../../data/ghostShip'); onAddDmMessage(formatShip(getRandomShip())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-blue-900/20 border border-blue-600/30 text-blue-400 hover:bg-blue-800/30 transition-all">⚓ Ghost Ship</button>
              <button onClick={async () => { const { getRandomGod, formatGod } = await import('../../data/forgottenGod'); onAddDmMessage(formatGod(getRandomGod())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-yellow-900/20 border border-yellow-600/30 text-yellow-400 hover:bg-yellow-800/30 transition-all">✨ Forgotten God</button>
              <button onClick={async () => { const { getRandomProphecy, formatProphecy } = await import('../../data/failedProphecy'); onAddDmMessage(formatProphecy(getRandomProphecy())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-orange-900/20 border border-orange-600/30 text-orange-400 hover:bg-orange-800/30 transition-all">🔮 Failed Prophecy</button>
              ...
              <button onClick={async () => { const { getRandomDream, formatDream } = await import('../../data/dreamRealmAdventure'); onAddDmMessage(formatDream(getRandomDream())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-indigo-900/20 border border-indigo-600/30 text-indigo-400 hover:bg-indigo-800/30 transition-all">💭 Dream Realm</button>
               <button onClick={async () => { const { getRandomTrial, formatTrial } = await import('../../data/magicalTrialByOrdeal'); onAddDmMessage(formatTrial(getRandomTrial())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-yellow-900/20 border border-yellow-600/30 text-yellow-400 hover:bg-yellow-800/30 transition-all">⚖️ Trial by Ordeal</button>

               {/* ═══════════════════════════════════════════════════ */}
               {/* Wave 70+ Unwired Data Systems                     */}
               {/* ═══════════════════════════════════════════════════ */}

               {/* Combat & Encounter */}
               <label className="text-[9px] text-red-400 font-bold uppercase mt-2 mb-1 block">⚔️ Combat & Encounter (New)</label>
               <button onClick={async () => { const m = await import('../../data/combatFatigue'); onAddDmMessage(m.formatFatigueState(m.createFatigueState())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-red-900/20 border border-red-600/30 text-red-400 hover:bg-red-800/30 transition-all">😤 Combat Fatigue</button>
               <button onClick={async () => { const m = await import('../../data/combatFlavor'); onAddDmMessage(`⚔️ **Combat Flavor:**\n🎯 Hit: *${m.hitFlavor()}*\n❌ Miss: *${m.missFlavor()}*\n💥 Crit: *${m.critFlavor()}*\n💀 Kill: *${m.killFlavor()}*\n🤦 Fumble: *${m.fumbleFlavor()}*`); }} className="w-full mb-1 text-[10px] py-1 rounded bg-red-900/20 border border-red-600/30 text-red-400 hover:bg-red-800/30 transition-all">🎭 Combat Flavor</button>
               <button onClick={async () => { const m = await import('../../data/combatOpeners'); onAddDmMessage(`⚔️ **Combat Opener:** *${m.combatOpener()}*`); }} className="w-full mb-1 text-[10px] py-1 rounded bg-red-900/20 border border-red-600/30 text-red-400 hover:bg-red-800/30 transition-all">📢 Combat Opener</button>
               <button onClick={async () => { const m = await import('../../data/combatQuip'); onAddDmMessage(m.formatQuip(m.getRandomQuip())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-red-900/20 border border-red-600/30 text-red-400 hover:bg-red-800/30 transition-all">💬 Combat Quip</button>
               <button onClick={async () => { const m = await import('../../data/combatTaunts'); onAddDmMessage(`😤 **Enemy Taunt:** *${m.getEnemyTaunt('generic')}*`); }} className="w-full mb-1 text-[10px] py-1 rounded bg-red-900/20 border border-red-600/30 text-red-400 hover:bg-red-800/30 transition-all">😤 Enemy Taunt</button>
               <button onClick={async () => { const m = await import('../../data/deathSaveDrama'); onAddDmMessage(m.formatNarration(m.getNarration('first_failure'))); }} className="w-full mb-1 text-[10px] py-1 rounded bg-red-900/20 border border-red-600/30 text-red-400 hover:bg-red-800/30 transition-all">💀 Death Save Drama</button>
               <button onClick={async () => { const m = await import('../../data/epicEntrance'); onAddDmMessage(m.formatEntrance(m.getRandomEntrance())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-orange-900/20 border border-orange-600/30 text-orange-400 hover:bg-orange-800/30 transition-all">🎭 Epic Entrance</button>
               <button onClick={async () => { const m = await import('../../data/fumbleTable'); const f = m.rollFumble(); onAddDmMessage(`🤦 **Fumble!** (${f.severity})\n${f.effect}${f.mechanical ? `\n*Mechanical: ${f.mechanical}*` : ''}`); }} className="w-full mb-1 text-[10px] py-1 rounded bg-red-900/20 border border-red-600/30 text-red-400 hover:bg-red-800/30 transition-all">🤦 Fumble Table</button>
               <button onClick={async () => { const m = await import('../../data/gladiatorArena'); onAddDmMessage(m.formatArenaState(m.createArenaState())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-orange-900/20 border border-orange-600/30 text-orange-400 hover:bg-orange-800/30 transition-all">🏟️ Gladiator Arena</button>
               <button onClick={async () => { const m = await import('../../data/massCombat'); const unit = m.UNIT_TEMPLATES[Math.floor(Math.random() * m.UNIT_TEMPLATES.length)]; onAddDmMessage(m.formatUnit(unit)); }} className="w-full mb-1 text-[10px] py-1 rounded bg-red-900/20 border border-red-600/30 text-red-400 hover:bg-red-800/30 transition-all">⚔️ Mass Combat Unit</button>
               <button onClick={async () => { const m = await import('../../data/siegeDefense'); onAddDmMessage(m.formatDefensePlan(m.getRandomDefensePlan())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-orange-900/20 border border-orange-600/30 text-orange-400 hover:bg-orange-800/30 transition-all">🏰 Siege Defense</button>
               <button onClick={async () => { const m = await import('../../data/terrainAdvantage'); onAddDmMessage(m.formatAllTerrain()); }} className="w-full mb-1 text-[10px] py-1 rounded bg-orange-900/20 border border-orange-600/30 text-orange-400 hover:bg-orange-800/30 transition-all">🗺️ Terrain Advantage</button>

               {/* World Building */}
               <label className="text-[9px] text-blue-400 font-bold uppercase mt-2 mb-1 block">🌍 World Building (New)</label>
               <button onClick={async () => { const m = await import('../../data/alchemicalForaging'); const r = m.forage('forest', 'summer', 3); onAddDmMessage(r ? m.formatForagingResult(r) : '🌿 Nothing found this time.'); }} className="w-full mb-1 text-[10px] py-1 rounded bg-green-900/20 border border-green-600/30 text-green-400 hover:bg-green-800/30 transition-all">🌿 Alchemical Foraging</button>
               <button onClick={async () => { const m = await import('../../data/alchemyRecipeBook'); const recipes = m.ALCHEMY_RECIPES; const r = recipes[Math.floor(Math.random() * recipes.length)]; onAddDmMessage(m.formatRecipe(r)); }} className="w-full mb-1 text-[10px] py-1 rounded bg-green-900/20 border border-green-600/30 text-green-400 hover:bg-green-800/30 transition-all">⚗️ Alchemy Recipe</button>
               <button onClick={async () => { const m = await import('../../data/arcaneResearch'); onAddDmMessage(m.formatProject(m.getRandomProject())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-indigo-900/20 border border-indigo-600/30 text-indigo-400 hover:bg-indigo-800/30 transition-all">🔬 Arcane Research</button>
               <button onClick={async () => { const m = await import('../../data/artifactCorruption'); const profiles = m.CORRUPTION_PROFILES; const p = profiles[Math.floor(Math.random() * profiles.length)]; onAddDmMessage(m.formatCorruptionProfile(p)); }} className="w-full mb-1 text-[10px] py-1 rounded bg-purple-900/20 border border-purple-600/30 text-purple-400 hover:bg-purple-800/30 transition-all">😈 Artifact Corruption</button>
               <button onClick={async () => { const m = await import('../../data/artifactGenerator'); onAddDmMessage(m.formatArtifact(m.generateArtifact())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-amber-900/20 border border-amber-600/30 text-amber-400 hover:bg-amber-800/30 transition-all">⭐ Artifact Generator</button>
               <button onClick={async () => { const m = await import('../../data/dragonHoardLayout'); onAddDmMessage(m.formatHoardLayout(m.getRandomHoardLayout())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-amber-900/20 border border-amber-600/30 text-amber-400 hover:bg-amber-800/30 transition-all">🐉 Dragon Hoard</button>
               <button onClick={async () => { const m = await import('../../data/dungeonRoomDressing'); onAddDmMessage(m.formatRoomDressing(m.getRandomRoomDressing())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-stone-700/30 border border-stone-500/30 text-stone-300 hover:bg-stone-600/30 transition-all">🏚️ Room Dressing</button>
               <button onClick={async () => { const m = await import('../../data/elementalInfusion'); const infusions = m.ELEMENTAL_INFUSIONS; const i = infusions[Math.floor(Math.random() * infusions.length)]; onAddDmMessage(m.formatInfusion(i)); }} className="w-full mb-1 text-[10px] py-1 rounded bg-orange-900/20 border border-orange-600/30 text-orange-400 hover:bg-orange-800/30 transition-all">🔥 Elemental Infusion</button>
               <button onClick={async () => { const m = await import('../../data/magicalAnomaly'); onAddDmMessage(m.formatAnomaly(m.getRandomAnomaly())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-purple-900/20 border border-purple-600/30 text-purple-400 hover:bg-purple-800/30 transition-all">🌀 Magical Anomaly</button>
               <button onClick={async () => { const m = await import('../../data/magicalEcosystem'); onAddDmMessage(m.formatEcosystem(m.getRandomEcosystem())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-green-900/20 border border-green-600/30 text-green-400 hover:bg-green-800/30 transition-all">🌿 Magical Ecosystem</button>
               <button onClick={async () => { const m = await import('../../data/magicalWeatherCalendar'); const cal = m.MAGICAL_WEATHER_CALENDAR; const day = cal[Math.floor(Math.random() * cal.length)]; onAddDmMessage(m.formatWeatherDay(day)); }} className="w-full mb-1 text-[10px] py-1 rounded bg-sky-900/20 border border-sky-600/30 text-sky-400 hover:bg-sky-800/30 transition-all">📅 Magical Weather</button>
               <button onClick={async () => { const m = await import('../../data/naturalDisaster'); onAddDmMessage(m.formatDisaster(m.getRandomDisaster())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-red-900/20 border border-red-600/30 text-red-400 hover:bg-red-800/30 transition-all">🌋 Natural Disaster</button>
               <button onClick={async () => { const m = await import('../../data/planarRift'); onAddDmMessage(m.formatRift(m.getRandomRift())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-indigo-900/20 border border-indigo-600/30 text-indigo-400 hover:bg-indigo-800/30 transition-all">🌀 Planar Rift</button>
               <button onClick={async () => { const m = await import('../../data/planarSideEffects'); onAddDmMessage(m.formatSideEffect(m.getRandomSideEffect())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-indigo-900/20 border border-indigo-600/30 text-indigo-400 hover:bg-indigo-800/30 transition-all">✨ Planar Side Effect</button>
               <button onClick={async () => { const m = await import('../../data/ritualMagic'); onAddDmMessage(m.formatRitual(m.getRandomRitual())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-purple-900/20 border border-purple-600/30 text-purple-400 hover:bg-purple-800/30 transition-all">🕯️ Ritual Magic</button>
               <button onClick={async () => { const m = await import('../../data/weatherEncounterInteraction'); const effect = m.getWeatherEncounterEffect('rain'); if (effect) onAddDmMessage(m.formatWeatherEncounterEffect(effect)); }} className="w-full mb-1 text-[10px] py-1 rounded bg-sky-900/20 border border-sky-600/30 text-sky-400 hover:bg-sky-800/30 transition-all">🌧️ Weather Encounter FX</button>
               <button onClick={async () => { const m = await import('../../data/weatherTerrainMod'); const effects = m.WEATHER_TERRAIN_EFFECTS; const e = effects[Math.floor(Math.random() * effects.length)]; onAddDmMessage(m.formatWeatherTerrain(e)); }} className="w-full mb-1 text-[10px] py-1 rounded bg-sky-900/20 border border-sky-600/30 text-sky-400 hover:bg-sky-800/30 transition-all">🌤️ Weather Terrain Mod</button>
               <button onClick={async () => { const m = await import('../../data/wildernessSurvival'); onAddDmMessage(m.formatSurvivalState(m.createSurvivalState())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-green-900/20 border border-green-600/30 text-green-400 hover:bg-green-800/30 transition-all">🏕️ Wilderness Survival</button>
               <button onClick={async () => { const m = await import('../../data/worldDetail'); onAddDmMessage(m.formatDetail(m.getRandomDetail())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-blue-900/20 border border-blue-600/30 text-blue-400 hover:bg-blue-800/30 transition-all">🌍 World Detail</button>
               <button onClick={async () => { const m = await import('../../data/worldSecret'); onAddDmMessage(m.formatSecret(m.getRandomSecret(), true)); }} className="w-full mb-1 text-[10px] py-1 rounded bg-purple-900/20 border border-purple-600/30 text-purple-400 hover:bg-purple-800/30 transition-all">🤫 World Secret</button>

               {/* NPCs & Social */}
               <label className="text-[9px] text-emerald-400 font-bold uppercase mt-2 mb-1 block">👥 NPCs & Social (New)</label>
               <button onClick={async () => { const m = await import('../../data/ancestralSpirit'); onAddDmMessage(m.formatSpirit(m.getRandomSpirit())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-emerald-900/20 border border-emerald-600/30 text-emerald-400 hover:bg-emerald-800/30 transition-all">👻 Ancestral Spirit</button>
               <button onClick={async () => { const m = await import('../../data/companionAnimal'); const c = m.createCompanion('Companion', m.getAllSpecies()[Math.floor(Math.random() * m.getAllSpecies().length)]); if (c) onAddDmMessage(m.formatCompanion(c)); }} className="w-full mb-1 text-[10px] py-1 rounded bg-emerald-900/20 border border-emerald-600/30 text-emerald-400 hover:bg-emerald-800/30 transition-all">🐾 Companion Animal</button>
               <button onClick={async () => { const m = await import('../../data/courtIntrigue'); onAddDmMessage(m.formatCourtState(m.createCourtState())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-pink-900/20 border border-pink-600/30 text-pink-400 hover:bg-pink-800/30 transition-all">👑 Court Intrigue</button>
               <button onClick={async () => { const m = await import('../../data/creatureDomestication'); onAddDmMessage(m.formatCreature(m.getRandomCreature())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-green-900/20 border border-green-600/30 text-green-400 hover:bg-green-800/30 transition-all">🐲 Creature Taming</button>
               <button onClick={async () => { const m = await import('../../data/diplomaticGift'); onAddDmMessage(m.formatGift(m.getRandomGift())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-amber-900/20 border border-amber-600/30 text-amber-400 hover:bg-amber-800/30 transition-all">🎁 Diplomatic Gift</button>
               <button onClick={async () => { const m = await import('../../data/diplomaticNegotiation'); onAddDmMessage(m.formatScenario(m.getRandomScenario())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-blue-900/20 border border-blue-600/30 text-blue-400 hover:bg-blue-800/30 transition-all">🤝 Negotiation</button>
               <button onClick={async () => { const m = await import('../../data/legendaryNPCDeath'); onAddDmMessage(m.formatSacrifice(m.getRandomSacrifice())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-slate-900/20 border border-slate-600/30 text-slate-400 hover:bg-slate-800/30 transition-all">⚰️ Legendary NPC Death</button>
               <button onClick={async () => { const m = await import('../../data/lyingMap'); onAddDmMessage(m.formatLyingMap(m.getRandomLyingMap())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-amber-900/20 border border-amber-600/30 text-amber-400 hover:bg-amber-800/30 transition-all">🗺️ Lying Map</button>
               <button onClick={async () => { const m = await import('../../data/magicalBond'); const bonds = m.MAGICAL_BONDS; const b = bonds[Math.floor(Math.random() * bonds.length)]; onAddDmMessage(m.formatBond(b)); }} className="w-full mb-1 text-[10px] py-1 rounded bg-pink-900/20 border border-pink-600/30 text-pink-400 hover:bg-pink-800/30 transition-all">💫 Magical Bond</button>
               <button onClick={async () => { const m = await import('../../data/magicalDuel'); const formats = m.DUEL_FORMATS; const f = formats[Math.floor(Math.random() * formats.length)]; onAddDmMessage(m.formatDuelFormat(f)); }} className="w-full mb-1 text-[10px] py-1 rounded bg-purple-900/20 border border-purple-600/30 text-purple-400 hover:bg-purple-800/30 transition-all">⚡ Magical Duel</button>
               <button onClick={async () => { const m = await import('../../data/monsterEcology'); const biomes = m.getAllBiomes(); const b = biomes[Math.floor(Math.random() * biomes.length)]; onAddDmMessage(m.formatBiomeEcology(b)); }} className="w-full mb-1 text-[10px] py-1 rounded bg-green-900/20 border border-green-600/30 text-green-400 hover:bg-green-800/30 transition-all">🐾 Monster Ecology</button>
               <button onClick={async () => { const m = await import('../../data/monsterHarvesting'); const profiles = m.HARVEST_PROFILES; const p = profiles[Math.floor(Math.random() * profiles.length)]; onAddDmMessage(m.formatHarvestProfile(p)); }} className="w-full mb-1 text-[10px] py-1 rounded bg-amber-900/20 border border-amber-600/30 text-amber-400 hover:bg-amber-800/30 transition-all">🔪 Monster Harvesting</button>
               <button onClick={async () => { const m = await import('../../data/npcLoyalty'); onAddDmMessage(m.formatLoyaltyTracker(m.createLoyaltyTracker())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-emerald-900/20 border border-emerald-600/30 text-emerald-400 hover:bg-emerald-800/30 transition-all">❤️ NPC Loyalty</button>
               <button onClick={async () => { const m = await import('../../data/npcSchedule'); const schedules = m.NPC_SCHEDULES; const s = schedules[Math.floor(Math.random() * schedules.length)]; onAddDmMessage(m.formatNpcSchedule(s)); }} className="w-full mb-1 text-[10px] py-1 rounded bg-cyan-900/20 border border-cyan-600/30 text-cyan-400 hover:bg-cyan-800/30 transition-all">📅 NPC Schedule</button>
               <button onClick={async () => { const m = await import('../../data/randomNpcFarewell'); onAddDmMessage(m.formatNpcFarewell()); }} className="w-full mb-1 text-[10px] py-1 rounded bg-emerald-900/20 border border-emerald-600/30 text-emerald-400 hover:bg-emerald-800/30 transition-all">👋 NPC Farewell</button>
               <button onClick={async () => { const m = await import('../../data/shapeshifterDetector'); const types = m.getAllShapeshifterTypes(); const t = types[Math.floor(Math.random() * types.length)]; const techs = m.getTechniquesForType(t); onAddDmMessage(techs.map((tech: any) => m.formatTechnique(tech)).join('\n\n')); }} className="w-full mb-1 text-[10px] py-1 rounded bg-yellow-900/20 border border-yellow-600/30 text-yellow-400 hover:bg-yellow-800/30 transition-all">🔍 Shapeshifter Detect</button>
               <button onClick={async () => { const m = await import('../../data/socialEncounter'); onAddDmMessage(m.formatSocialEncounter(m.getRandomSocialEncounter())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-emerald-900/20 border border-emerald-600/30 text-emerald-400 hover:bg-emerald-800/30 transition-all">🤝 Social Encounter</button>

               {/* Story & Plot */}
               <label className="text-[9px] text-yellow-400 font-bold uppercase mt-2 mb-1 block">📜 Story & Plot (New)</label>
               <button onClick={async () => { const m = await import('../../data/arcaneAddiction'); const sources = m.getAllAddictionSources(); const s = sources[Math.floor(Math.random() * sources.length)]; const p = m.getAddictionProfile(s); if (p) onAddDmMessage(m.formatAddiction(p)); }} className="w-full mb-1 text-[10px] py-1 rounded bg-purple-900/20 border border-purple-600/30 text-purple-400 hover:bg-purple-800/30 transition-all">🧪 Arcane Addiction</button>
               <button onClick={async () => { const m = await import('../../data/backstoryComplication'); onAddDmMessage(m.formatComplication(m.getRandomComplication())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-orange-900/20 border border-orange-600/30 text-orange-400 hover:bg-orange-800/30 transition-all">📖 Backstory Twist</button>
               <button onClick={async () => { const m = await import('../../data/cursedAuction'); onAddDmMessage(m.formatAuction(m.getRandomAuction())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-amber-900/20 border border-amber-600/30 text-amber-400 hover:bg-amber-800/30 transition-all">🏛️ Cursed Auction</button>
               <button onClick={async () => { const m = await import('../../data/curseLayered'); onAddDmMessage(m.formatLayeredCurse(m.getRandomLayeredCurse())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-purple-900/20 border border-purple-600/30 text-purple-400 hover:bg-purple-800/30 transition-all">😈 Layered Curse</button>
               <button onClick={async () => { const m = await import('../../data/detectiveCase'); onAddDmMessage(m.formatCase(m.getRandomCase())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-blue-900/20 border border-blue-600/30 text-blue-400 hover:bg-blue-800/30 transition-all">🔍 Detective Case</button>
               <button onClick={async () => { const m = await import('../../data/divineIntervention'); onAddDmMessage(m.formatIntervention(m.getRandomIntervention())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-yellow-900/20 border border-yellow-600/30 text-yellow-400 hover:bg-yellow-800/30 transition-all">✨ Divine Intervention</button>
               <button onClick={async () => { const m = await import('../../data/dreamSequence'); onAddDmMessage(m.formatDream(m.getRandomDream())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-indigo-900/20 border border-indigo-600/30 text-indigo-400 hover:bg-indigo-800/30 transition-all">💤 Dream Sequence</button>
               <button onClick={async () => { const m = await import('../../data/dreamCombat'); onAddDmMessage(m.formatDreamCombat(m.getRandomDreamCombat())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-indigo-900/20 border border-indigo-600/30 text-indigo-400 hover:bg-indigo-800/30 transition-all">⚔️ Dream Combat</button>
               <button onClick={async () => { const m = await import('../../data/factionWar'); onAddDmMessage(m.formatFactionWar(m.createFactionWar())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-red-900/20 border border-red-600/30 text-red-400 hover:bg-red-800/30 transition-all">⚔️ Faction War</button>
               <button onClick={async () => { const m = await import('../../data/firstSession'); onAddDmMessage(m.formatHook(m.getRandomHook())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-green-900/20 border border-green-600/30 text-green-400 hover:bg-green-800/30 transition-all">🎬 First Session Hook</button>
               <button onClick={async () => { const m = await import('../../data/legendaryWeapon'); onAddDmMessage(m.formatLegendaryWeapon(m.getRandomLegendaryWeapon())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-amber-900/20 border border-amber-600/30 text-amber-400 hover:bg-amber-800/30 transition-all">🗡️ Legendary Weapon</button>
               <button onClick={async () => { const m = await import('../../data/mindControl'); const sources = m.getAllControlSources(); const s = sources[Math.floor(Math.random() * sources.length)]; onAddDmMessage(m.formatMindControlState(m.createMindControlState(s))); }} className="w-full mb-1 text-[10px] py-1 rounded bg-purple-900/20 border border-purple-600/30 text-purple-400 hover:bg-purple-800/30 transition-all">🧠 Mind Control</button>
               <button onClick={async () => { const m = await import('../../data/moralDilemma'); onAddDmMessage(m.formatDilemma(m.getRandomDilemma(), true)); }} className="w-full mb-1 text-[10px] py-1 rounded bg-violet-900/20 border border-violet-600/30 text-violet-400 hover:bg-violet-800/30 transition-all">⚖️ Moral Dilemma</button>
               <button onClick={async () => { const m = await import('../../data/planarInvasion'); onAddDmMessage(m.formatProtocol(m.getRandomProtocol())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-red-900/20 border border-red-600/30 text-red-400 hover:bg-red-800/30 transition-all">🌀 Planar Invasion</button>
               <button onClick={async () => { const m = await import('../../data/planarRefugee'); onAddDmMessage(m.formatRefugeeGroup(m.getRandomRefugeeGroup())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-blue-900/20 border border-blue-600/30 text-blue-400 hover:bg-blue-800/30 transition-all">🏕️ Planar Refugee</button>
               <button onClick={async () => { const m = await import('../../data/plotTwistEngine'); onAddDmMessage(m.formatTwist(m.getRandomTwist(), true)); }} className="w-full mb-1 text-[10px] py-1 rounded bg-fuchsia-900/20 border border-fuchsia-600/30 text-fuchsia-400 hover:bg-fuchsia-800/30 transition-all">🌋 Plot Twist Engine</button>
               <button onClick={async () => { const m = await import('../../data/prophecyFulfillment'); const p = m.getRandomProphecy(); onAddDmMessage(`🔮 **Prophecy:** *"${p.text}"*\nSource: ${p.source} | Category: ${p.category}`); }} className="w-full mb-1 text-[10px] py-1 rounded bg-purple-900/20 border border-purple-600/30 text-purple-400 hover:bg-purple-800/30 transition-all">🔮 Prophecy</button>
               <button onClick={async () => { const m = await import('../../data/questRewardNegotiation'); onAddDmMessage(m.formatNegotiation(m.getRandomNegotiation())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-amber-900/20 border border-amber-600/30 text-amber-400 hover:bg-amber-800/30 transition-all">💰 Reward Negotiation</button>
               <button onClick={async () => { const m = await import('../../data/sessionZero'); onAddDmMessage(m.formatQuestion(m.getRandomQuestion())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-green-900/20 border border-green-600/30 text-green-400 hover:bg-green-800/30 transition-all">📋 Session Zero Q</button>
               <button onClick={async () => { const m = await import('../../data/warlockPatron'); const types = m.getAllPatronTypes(); const t = types[Math.floor(Math.random() * types.length)]; const p = m.getPatron(t); if (p) onAddDmMessage(m.formatPatron(p)); }} className="w-full mb-1 text-[10px] py-1 rounded bg-red-900/20 border border-red-600/30 text-red-400 hover:bg-red-800/30 transition-all">👹 Warlock Patron</button>

               {/* Items & Treasure */}
               <label className="text-[9px] text-amber-400 font-bold uppercase mt-2 mb-1 block">💎 Items & Treasure (New)</label>
               <button onClick={async () => { const m = await import('../../data/craftingSpecialization'); const disc = m.getAllDisciplines(); const d = disc[Math.floor(Math.random() * disc.length)]; onAddDmMessage(m.formatSpecialization(m.createSpecialization(d))); }} className="w-full mb-1 text-[10px] py-1 rounded bg-amber-900/20 border border-amber-600/30 text-amber-400 hover:bg-amber-800/30 transition-all">🔨 Crafting Spec</button>
               <button onClick={async () => { const m = await import('../../data/evolvingTrap'); onAddDmMessage(m.formatEvolvingTrap(m.getRandomEvolvingTrap())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-red-900/20 border border-red-600/30 text-red-400 hover:bg-red-800/30 transition-all">🪤 Evolving Trap</button>
               <button onClick={async () => { const m = await import('../../data/golemCrafting'); const types = m.getAllGolemTypes(); const t = types[Math.floor(Math.random() * types.length)]; const b = m.getBlueprint(t); if (b) onAddDmMessage(m.formatBlueprint(b)); }} className="w-full mb-1 text-[10px] py-1 rounded bg-stone-700/30 border border-stone-500/30 text-stone-300 hover:bg-stone-600/30 transition-all">🤖 Golem Crafting</button>
               <button onClick={async () => { const m = await import('../../data/lycanthropy'); const types = m.getAllTypes(); const t = types[Math.floor(Math.random() * types.length)]; onAddDmMessage(m.formatLycanthropy(m.createLycanthropyState(t))); }} className="w-full mb-1 text-[10px] py-1 rounded bg-yellow-900/20 border border-yellow-600/30 text-yellow-400 hover:bg-yellow-800/30 transition-all">🐺 Lycanthropy</button>
               <button onClick={async () => { const m = await import('../../data/magicalContract'); onAddDmMessage(m.formatContract(m.getRandomContract(), true)); }} className="w-full mb-1 text-[10px] py-1 rounded bg-red-900/20 border border-red-600/30 text-red-400 hover:bg-red-800/30 transition-all">📜 Magical Contract</button>
               <button onClick={async () => { const m = await import('../../data/magicalDisease'); onAddDmMessage(m.formatDisease(m.getRandomDisease())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-green-900/20 border border-green-600/30 text-green-400 hover:bg-green-800/30 transition-all">🦠 Magical Disease</button>
               <button onClick={async () => { const m = await import('../../data/magicalTattoo'); onAddDmMessage(m.formatTattoo(m.getRandomTattoo())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-pink-900/20 border border-pink-600/30 text-pink-400 hover:bg-pink-800/30 transition-all">🎨 Magical Tattoo</button>
               <button onClick={async () => { const m = await import('../../data/poisonCrafting'); onAddDmMessage(m.formatPoison(m.getRandomPoison())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-green-900/20 border border-green-600/30 text-green-400 hover:bg-green-800/30 transition-all">☠️ Poison Crafting</button>
               <button onClick={async () => { const m = await import('../../data/summoningMishap'); onAddDmMessage(m.formatMishap(m.getRandomMishap())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-purple-900/20 border border-purple-600/30 text-purple-400 hover:bg-purple-800/30 transition-all">🌀 Summoning Mishap</button>
               <button onClick={async () => { const m = await import('../../data/tattooRemoval'); const methods = m.getAllRemovalMethods(); const method = methods[Math.floor(Math.random() * methods.length)]; const opt = m.getRemovalOption(method); if (opt) onAddDmMessage(m.formatRemovalOption(opt)); }} className="w-full mb-1 text-[10px] py-1 rounded bg-pink-900/20 border border-pink-600/30 text-pink-400 hover:bg-pink-800/30 transition-all">🧹 Tattoo Removal</button>
               <button onClick={async () => { const m = await import('../../data/weaponSentienceAwaken'); onAddDmMessage(m.formatAwakening(m.getRandomAwakening())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-amber-900/20 border border-amber-600/30 text-amber-400 hover:bg-amber-800/30 transition-all">🗡️ Weapon Sentience</button>

               {/* Maritime & Travel */}
               <label className="text-[9px] text-cyan-400 font-bold uppercase mt-2 mb-1 block">⛵ Maritime & Travel</label>
               <button onClick={async () => { const m = await import('../../data/airshipEncounter'); onAddDmMessage(m.formatAirEncounter(m.getRandomAirEncounter())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-cyan-900/20 border border-cyan-600/30 text-cyan-400 hover:bg-cyan-800/30 transition-all">🎈 Airship Encounter</button>
               <button onClick={async () => { const m = await import('../../data/astralEncounter'); onAddDmMessage(m.formatAstralEncounter(m.getRandomAstralEncounter())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-indigo-900/20 border border-indigo-600/30 text-indigo-400 hover:bg-indigo-800/30 transition-all">✨ Astral Encounter</button>
               <button onClick={async () => { const m = await import('../../data/astralShipCombat'); const weapons = m.ASTRAL_WEAPONS; const w = weapons[Math.floor(Math.random() * weapons.length)]; const shields = m.ASTRAL_SHIELDS; const s = shields[Math.floor(Math.random() * shields.length)]; onAddDmMessage(`⚔️ **Astral Ship Combat:**\n${m.formatWeapon(w)}\n\n${m.formatShield(s)}`); }} className="w-full mb-1 text-[10px] py-1 rounded bg-indigo-900/20 border border-indigo-600/30 text-indigo-400 hover:bg-indigo-800/30 transition-all">🚀 Astral Ship Combat</button>
               <button onClick={async () => { const m = await import('../../data/merchantCaravan'); onAddDmMessage(m.formatCaravan(m.generateCaravan())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-amber-900/20 border border-amber-600/30 text-amber-400 hover:bg-amber-800/30 transition-all">🐪 Merchant Caravan</button>
               <button onClick={async () => { const m = await import('../../data/navalCombat'); onAddDmMessage(m.formatShip(m.createShip('The Tempest', 'galleon'))); }} className="w-full mb-1 text-[10px] py-1 rounded bg-blue-900/20 border border-blue-600/30 text-blue-400 hover:bg-blue-800/30 transition-all">⚓ Naval Combat</button>
               <button onClick={async () => { const m = await import('../../data/shipCargo'); onAddDmMessage(m.formatManifest(m.generateManifest('northern_kingdom', 'island_chain'))); }} className="w-full mb-1 text-[10px] py-1 rounded bg-amber-900/20 border border-amber-600/30 text-amber-400 hover:bg-amber-800/30 transition-all">📦 Ship Cargo</button>
               <button onClick={async () => { const m = await import('../../data/shipCrewManagement'); onAddDmMessage(m.formatCrewState(m.createCrewState())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-cyan-900/20 border border-cyan-600/30 text-cyan-400 hover:bg-cyan-800/30 transition-all">👥 Ship Crew</button>
               <button onClick={async () => { const m = await import('../../data/shipwreckGenerator'); onAddDmMessage(m.formatShipwreck(m.getRandomShipwreck())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-blue-900/20 border border-blue-600/30 text-blue-400 hover:bg-blue-800/30 transition-all">🚢 Shipwreck</button>
               <button onClick={async () => { const m = await import('../../data/travelMontage'); onAddDmMessage(m.formatMontage(m.getRandomMontage())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-green-900/20 border border-green-600/30 text-green-400 hover:bg-green-800/30 transition-all">🗺️ Travel Montage</button>
               <button onClick={async () => { const m = await import('../../data/undergroundRiver'); const routes = m.getAllRoutes(); const r = routes[Math.floor(Math.random() * routes.length)]; onAddDmMessage(m.formatRoute(r)); }} className="w-full mb-1 text-[10px] py-1 rounded bg-blue-900/20 border border-blue-600/30 text-blue-400 hover:bg-blue-800/30 transition-all">🌊 Underground River</button>

               {/* Misc & Specialized */}
               <label className="text-[9px] text-teal-400 font-bold uppercase mt-2 mb-1 block">🎲 Misc & Specialized (New)</label>
               <button onClick={async () => { const m = await import('../../data/bardicInspiration'); const moments = m.getAllMoments(); const moment = moments[Math.floor(Math.random() * moments.length)]; onAddDmMessage(m.formatInspiration(m.getInspirationForMoment(moment))); }} className="w-full mb-1 text-[10px] py-1 rounded bg-pink-900/20 border border-pink-600/30 text-pink-400 hover:bg-pink-800/30 transition-all">🎵 Bardic Inspiration</button>
               <button onClick={async () => { const m = await import('../../data/bountyBoardAdvanced'); onAddDmMessage(m.formatAdvancedBounty(m.getRandomAdvancedBounty())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-amber-900/20 border border-amber-600/30 text-amber-400 hover:bg-amber-800/30 transition-all">📜 Advanced Bounty</button>
               <button onClick={async () => { const m = await import('../../data/crossPlaneMessenger'); onAddDmMessage(m.formatService(m.getRandomService())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-indigo-900/20 border border-indigo-600/30 text-indigo-400 hover:bg-indigo-800/30 transition-all">📨 Planar Messenger</button>
               <button onClick={async () => { const m = await import('../../data/familiarEvolution'); const names = m.getAllFamiliarNames(); const n = names[Math.floor(Math.random() * names.length)]; const evo = m.getEvolution(n); if (evo) onAddDmMessage(m.formatFamiliarEvolution(evo)); }} className="w-full mb-1 text-[10px] py-1 rounded bg-emerald-900/20 border border-emerald-600/30 text-emerald-400 hover:bg-emerald-800/30 transition-all">🐾 Familiar Evolution</button>
               <button onClick={async () => { const m = await import('../../data/festivalAdvanced'); onAddDmMessage(m.formatAdvancedFestival(m.getRandomAdvancedFestival())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-pink-900/20 border border-pink-600/30 text-pink-400 hover:bg-pink-800/30 transition-all">🎉 Advanced Festival</button>
               <button onClick={async () => { const m = await import('../../data/guildMembership'); const types = m.getAllGuildTypes(); const t = types[Math.floor(Math.random() * types.length)]; const g = m.getGuild(t); if (g) onAddDmMessage(m.formatGuild(g)); }} className="w-full mb-1 text-[10px] py-1 rounded bg-amber-900/20 border border-amber-600/30 text-amber-400 hover:bg-amber-800/30 transition-all">⚜️ Guild Membership</button>
               <button onClick={async () => { const m = await import('../../data/heistPlanner'); onAddDmMessage(m.formatHeist(m.getRandomHeist())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-slate-900/20 border border-slate-600/30 text-slate-400 hover:bg-slate-800/30 transition-all">🔓 Heist Planner</button>
               <button onClick={async () => { const m = await import('../../data/illithidColony'); onAddDmMessage(m.formatColony(m.getRandomColony())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-purple-900/20 border border-purple-600/30 text-purple-400 hover:bg-purple-800/30 transition-all">🧠 Illithid Colony</button>
               <button onClick={async () => { const m = await import('../../data/interplanarCustoms'); onAddDmMessage(m.formatCustomsOffice(m.getRandomCustomsOffice())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-cyan-900/20 border border-cyan-600/30 text-cyan-400 hover:bg-cyan-800/30 transition-all">🛃 Planar Customs</button>
               <button onClick={async () => { const m = await import('../../data/lastResort'); onAddDmMessage(m.formatLastResort(m.getRandomLastResort())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-red-900/20 border border-red-600/30 text-red-400 hover:bg-red-800/30 transition-all">🆘 Last Resort</button>
               <button onClick={async () => { const m = await import('../../data/libraryResearch'); const sizes = ['private_shelf', 'town_library', 'university', 'grand_archive', 'forbidden_vault'] as const; const s = sizes[Math.floor(Math.random() * sizes.length)]; const lib = m.getLibraryBySize(s); if (lib) onAddDmMessage(m.formatLibrary(lib)); }} className="w-full mb-1 text-[10px] py-1 rounded bg-amber-900/20 border border-amber-600/30 text-amber-400 hover:bg-amber-800/30 transition-all">📚 Library Research</button>
               <button onClick={async () => { const m = await import('../../data/magicalCommunication'); const methods = m.COMMUNICATION_METHODS; const method = methods[Math.floor(Math.random() * methods.length)]; onAddDmMessage(m.formatMethod(method)); }} className="w-full mb-1 text-[10px] py-1 rounded bg-blue-900/20 border border-blue-600/30 text-blue-400 hover:bg-blue-800/30 transition-all">📡 Magic Comms</button>
               <button onClick={async () => { const m = await import('../../data/magicalLibraryCatalog'); onAddDmMessage(m.formatSection(m.getRandomSection())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-indigo-900/20 border border-indigo-600/30 text-indigo-400 hover:bg-indigo-800/30 transition-all">📖 Magic Library</button>
               <button onClick={async () => { const m = await import('../../data/planarMarketplace'); onAddDmMessage(m.formatPlanarShop(m.getRandomPlanarShop())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-purple-900/20 border border-purple-600/30 text-purple-400 hover:bg-purple-800/30 transition-all">🏪 Planar Market</button>
               <button onClick={async () => { const m = await import('../../data/politicalEvent'); onAddDmMessage(m.formatPoliticalEvent(m.getRandomPoliticalEvent())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-red-900/20 border border-red-600/30 text-red-400 hover:bg-red-800/30 transition-all">🏛️ Political Event</button>
               <button onClick={async () => { const m = await import('../../data/puzzleLock'); onAddDmMessage(m.formatPuzzle(m.getRandomPuzzle())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-violet-900/20 border border-violet-600/30 text-violet-400 hover:bg-violet-800/30 transition-all">🔐 Puzzle Lock</button>
               <button onClick={async () => { const m = await import('../../data/regionalReputation'); onAddDmMessage(m.formatRegionalTracker(m.createRegionalTracker())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-amber-900/20 border border-amber-600/30 text-amber-400 hover:bg-amber-800/30 transition-all">📢 Regional Rep</button>
               <button onClick={async () => { const m = await import('../../data/rumor'); onAddDmMessage(m.formatRumor(m.getRandomRumor(), true)); }} className="w-full mb-1 text-[10px] py-1 rounded bg-purple-900/20 border border-purple-600/30 text-purple-400 hover:bg-purple-800/30 transition-all">🤫 Rumor (Detailed)</button>
               <button onClick={async () => { const m = await import('../../data/sessionEnder'); onAddDmMessage(m.formatEnder(m.getRandomEnder())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-purple-900/20 border border-purple-600/30 text-purple-400 hover:bg-purple-800/30 transition-all">🎬 Session Ender</button>
               <button onClick={async () => { const m = await import('../../data/siegeWarfare'); const engines = m.SIEGE_ENGINES; const lines = engines.map((e: any) => m.formatSiegeEngine(e)); onAddDmMessage(lines.join('\n\n')); }} className="w-full mb-1 text-[10px] py-1 rounded bg-red-900/20 border border-red-600/30 text-red-400 hover:bg-red-800/30 transition-all">🏰 Siege Warfare</button>
               <button onClick={async () => { const m = await import('../../data/tavernBrawl'); onAddDmMessage(m.formatBrawl(m.generateBrawl())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-amber-900/20 border border-amber-600/30 text-amber-400 hover:bg-amber-800/30 transition-all">🍺💥 Tavern Brawl</button>
               <button onClick={async () => { const m = await import('../../data/tavernReputation'); onAddDmMessage(m.formatTavernReputation(m.createTavernTracker().taverns[0] || { name: 'The Rusty Nail', tier: 'common' as any, score: 0, reputation: 'unknown' as any, events: [], banned: false })); }} className="w-full mb-1 text-[10px] py-1 rounded bg-amber-900/20 border border-amber-600/30 text-amber-400 hover:bg-amber-800/30 transition-all">🍺 Tavern Rep</button>
               <button onClick={async () => { const m = await import('../../data/thievesGuildJobs'); onAddDmMessage(m.formatGuildJob(m.getRandomJob())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-slate-900/20 border border-slate-600/30 text-slate-400 hover:bg-slate-800/30 transition-all">🗡️ Thieves Guild Job</button>
               <button onClick={async () => { const m = await import('../../data/tournamentBracket'); onAddDmMessage(m.formatTournament(m.createTournament('Grand Tournament', 'melee'))); }} className="w-full mb-1 text-[10px] py-1 rounded bg-yellow-900/20 border border-yellow-600/30 text-yellow-400 hover:bg-yellow-800/30 transition-all">🏆 Tournament</button>
               <button onClick={async () => { const m = await import('../../data/trapDisarm'); onAddDmMessage(m.formatChallenge(m.getRandomChallenge(), true)); }} className="w-full mb-1 text-[10px] py-1 rounded bg-red-900/20 border border-red-600/30 text-red-400 hover:bg-red-800/30 transition-all">🪤 Trap Disarm</button>
               <button onClick={async () => { const m = await import('../../data/undergroundFaction'); onAddDmMessage(m.formatFaction(m.getRandomFaction())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-slate-900/20 border border-slate-600/30 text-slate-400 hover:bg-slate-800/30 transition-all">🕵️ Underground Faction</button>
               <button onClick={async () => { const m = await import('../../data/vampireBloodline'); const names = m.getAllBloodlines(); const n = names[Math.floor(Math.random() * names.length)]; onAddDmMessage(m.formatVampireState(m.createVampireState(n))); }} className="w-full mb-1 text-[10px] py-1 rounded bg-red-900/20 border border-red-600/30 text-red-400 hover:bg-red-800/30 transition-all">🧛 Vampire Bloodline</button>
               <button onClick={async () => { const m = await import('../../data/villainMotivation'); onAddDmMessage(m.formatMotivation(m.getRandomMotivation())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-red-900/20 border border-red-600/30 text-red-400 hover:bg-red-800/30 transition-all">😈 Villain Motivation</button>
               <button onClick={async () => { const m = await import('../../data/wantedPoster'); onAddDmMessage(m.formatWantedPoster(m.generateWantedPoster('Unknown Criminal', 'dangerous'))); }} className="w-full mb-1 text-[10px] py-1 rounded bg-orange-900/20 border border-orange-600/30 text-orange-400 hover:bg-orange-800/30 transition-all">📜 Wanted Poster</button>
               <button onClick={async () => { const m = await import('../../data/warRoomBriefing'); onAddDmMessage(m.formatBriefing(m.getRandomBriefing())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-red-900/20 border border-red-600/30 text-red-400 hover:bg-red-800/30 transition-all">🗺️ War Room Briefing</button>
               <button onClick={async () => { const m = await import('../../data/wildMagic'); const { roll, effect } = m.rollWildMagic(); onAddDmMessage(`🌀 **Wild Magic Surge** (d100: ${roll})\n${effect.effect}${effect.mechanical ? `\n*${effect.mechanical}*` : ''}`); }} className="w-full mb-1 text-[10px] py-1 rounded bg-fuchsia-900/20 border border-fuchsia-600/30 text-fuchsia-400 hover:bg-fuchsia-800/30 transition-all">🌀 Wild Magic (PHB)</button>
               <button onClick={async () => { const m = await import('../../data/wildMagicExpanded'); onAddDmMessage(m.formatExpandedSurge(m.rollExpandedSurge())); }} className="w-full mb-1 text-[10px] py-1 rounded bg-fuchsia-900/20 border border-fuchsia-600/30 text-fuchsia-400 hover:bg-fuchsia-800/30 transition-all">🌀 Wild Magic Expanded</button>
               <button onClick={async () => { const m = await import('../../data/wildShapeBestiary'); const forms = m.getFormsByLevel(8); const f = forms[Math.floor(Math.random() * forms.length)]; onAddDmMessage(m.formatWildShapeForm(f)); }} className="w-full mb-1 text-[10px] py-1 rounded bg-green-900/20 border border-green-600/30 text-green-400 hover:bg-green-800/30 transition-all">🐻 Wild Shape Form</button>
