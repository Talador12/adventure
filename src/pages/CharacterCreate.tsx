...
// PORTRAIT_STYLES, PortraitStyle, PortraitMode moved to AppearanceStep component
...
export default function CharacterCreate() {
  ...
  // portraitMode + portraitStyle state moved into AppearanceStep component
  ...
  useEffect(() => {
    ...
    if (editingCharacter.portrait) {
      ...
      setPortraitSource('upload'); // AppearanceStep infers portraitMode from portraitSource
    }
  ...
  const generatePortrait = useCallback(async (style: PortraitStyle = 'classic-fantasy') => {
  ...
  }, [name, race, charClass, appearance, toast]);
      ...
      <div className="relative max-w-5xl mx-auto flex gap-6 p-6">
        ...
        {step === 1 && (
          <AppearanceStep
            ...
            illustratedPortrait={illustratedPortrait}
            defaultPortraitSvg={defaultPortraitSvg}
            ...
            onPortraitClear={() => { setPortrait(null); setPortraitSource(null); }}
            onGeneratePortrait={generatePortrait}
            onUploadPortrait={handleUploadPortrait}
            onAnalyzeUploadChange={setAnalyzeUpload}
          />
        )}
