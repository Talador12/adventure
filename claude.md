...
- Party loot tracker (shared inventory, DM distributes items to players)
- Quick rules reference panel (conditions, actions, spell schools during play)
- Session timer (track total play time per session, auto-save on idle)
- Encounter history log (damage dealt, spells cast, rounds survived)
