...
describe('conditions', () => {
  it('all condition types have effects defined', () => {
    const types = ['poisoned', 'stunned', 'frightened', 'blessed', 'hexed', 'burning', 'prone', 'dodging', 'raging', 'inspired', 'helping', 'hidden', 'grappled', 'smiteArmed', 'hunterMarked', 'torchlit', 'darkvision', 'candlelit', 'lantern', 'daylight'];
